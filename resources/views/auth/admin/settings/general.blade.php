            ...
            <div class="col-md-12 card-body">
                <form action="{{ route('admin.settings.general', $gen_settings->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Maximum Withdraw</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Referrer Bonus</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Referred Bonus</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">Referral Withdraw Limit</label>
