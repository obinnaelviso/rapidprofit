...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-simplebar>
        ...
        <p class="mb-5">Check the email sent to you to verify your {{ config('app.name') }} Account </p>
        ...
        <form method="POST" action="{{ route('verification.resend') }}">
            ...
            @endif
            <button type="submit" class="btn btn-primary btn-lg btn-block text-capitalize">{{ __('click here to request another') }}</button>
        </form>
