...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $referral_limit = property_exists($general, 'referral_limit') ? $general->referral_limit:100;
    ...
    public function deposit() {
        $user = $this->user();
        $general = settings('general');
        $min_dep = property_exists($general, 'min_dep') ?$general->min_dep:100;
        $max_dep = property_exists($general, 'max_dep') ?$general->max_dep:1000000;
